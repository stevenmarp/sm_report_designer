# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Design Odoo 16 reports from Word (.docx) and Excel (.xlsx) templates — no developer needed',
    'description': """
Report Designer - Word & Excel Template Engine (Odoo 16)
========================================================

Fully compatible with **Odoo 16** Community and Enterprise.
