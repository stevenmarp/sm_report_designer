# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Design Odoo 15 reports from Word (.docx) and Excel (.xlsx) templates — no developer needed',
    'description': """
Report Designer - Word & Excel Template Engine (Odoo 15)
========================================================

Fully compatible with **Odoo 15** Community and Enterprise.
