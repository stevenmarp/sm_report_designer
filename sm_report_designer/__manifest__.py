# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Design Odoo 17 reports from Word (.docx) and Excel (.xlsx) templates — no developer needed',
    'description': """
Report Designer - Word & Excel Template Engine (Odoo 17)
========================================================

Fully compatible with **Odoo 17** Community and Enterprise.
